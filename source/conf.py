...
project = 'Introduction to Photonics 2'
...
.. only:: html
    ...
    .. nbinfo::
        ...
        :raw-html:`<br/><a href="https://mybinder.org/v2/gh/fcichos/photonics2/master?urlpath=lab/tree/{{ docname }}"><img alt="Binder badge" src="https://img.shields.io/badge/launch-full%20binder-red.svg" style="vertical-align:text-bottom"></a>`
